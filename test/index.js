...
const fn_tests = async () => {
  {
    const raw = '07070a0000001601b2a4f12006b191111b11faa0a126bcddded861de0007070a000000160000f9a61eefd5d12786e70433b1edc846ac9eb5fcd60707030a0707009503070700a3db97010000'.toUpperCase()
    const decoded = TBC.codec.decodeRawBytes(raw)
    ...
    assert(JSON.stringify(decoded) === answer, 'FN: decodeRawBytes')

    const encoded = TBC.codec.encodeRawBytes(decoded)
    assert(encoded === raw, 'FN: encodeRawBytes')
  }
